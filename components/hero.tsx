    ...
    return (
        <div className="grid grid-rows-2 gap-30">
            <div className="relative flex flex-col items-center">
                ...
                <Image src={"/assets/images/hero-profile.jpg"} alt="Background Image" className="absolute bottom-0 translate-y-1/2 rounded-full border-8 border-amber-300 w-50 h-50" width={600} height={100} />
            </div>
            <div className="p-3">
                <p className="m-auto">
